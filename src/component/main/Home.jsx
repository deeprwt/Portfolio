...
import back from "../../assets/images/background2.jpg";
import code from "../../assets/images/allcode.jpg";
...
export const Home = () => {
  return (
    <>
          ...
          <div className="flex w-full sm:w-8/12 flex-col justify-center">
            <h1 className="flex  items-center font-bold font-serif">
              <span className="text-[#002057] text-4xl sm:text-6xl">
                Hi, <br />
                I'm<span className=" text-rose-500 "> Deepak Rawat</span>
                <br />
                Web Developer
              </span>
            </h1>
      ...
      <div className="w-[90%] m-auto flex flex-col sm:flex-row mt-40">
        <Story />
      </div>
